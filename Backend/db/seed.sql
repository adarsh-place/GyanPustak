INSERT INTO students (first_name, last_name, email, address, phone_number, date_of_birth, university_affiliation, major_field_of_study, student_status, year_of_study, password_hash)
VALUES
  ('Aarav', 'Sharma', 'aarav@college.edu', 'Delhi', '9000000001', '2003-05-14', 'U01', 'Computer Science', 'undergraduate', '3rd Year', '$2a$10$placeholder')
...
INSERT INTO course_departments (course_id, university_id, department_name)
VALUES
  ('CS301', 'U01', 'Computer Science'),
  ('CS201', 'U01', 'Computer Science')
...
INSERT INTO books (title, type, purchase_option, price, quantity, isbn, publisher, publication_date, edition_number, language, format, category, subcategories, rating)
VALUES
  ('Database System Concepts', 'new', ARRAY['buy', 'rent'], 780, 15, '9780073523323', 'McGraw Hill', '2021-01-10', '7th', 'English', 'hardcover', 'Databases', ARRAY['SQL', 'RDBMS'], 4.6),
  ('Operating System Principles', 'used', ARRAY['buy'], 420, 8, '9781118063330', 'Wiley', '2019-06-25', '9th', 'English', 'softcover', 'Operating Systems', ARRAY['Processes', 'Scheduling'], 4.2),
  ('Data Structures in C++', 'new', ARRAY['buy', 'rent'], 320, 100, '9780132847377', 'Pearson', '2020-04-19', '4th', 'English', 'electronic', 'Programming', ARRAY['Data Structures'], 4.7)
ON CONFLICT (isbn) DO NOTHING;

INSERT INTO book_authors (book_id, author_name, author_order)
VALUES
  ('9780073523323', 'Silberschatz', 1),
  ('9780073523323', 'Korth', 2),
  ('9781118063330', 'Galvin', 1),
  ('9780132847377', 'Mark Allen Weiss', 1)
ON CONFLICT DO NOTHING;

INSERT INTO book_keywords (book_id, keyword)
VALUES
  ('9780073523323', 'database'),
  ('9780073523323', 'sql'),
  ('9780073523323', 'normalization'),
  ('9781118063330', 'os'),
  ('9781118063330', 'kernel'),
  ('9780132847377', 'trees'),
  ('9780132847377', 'graphs'),
  ('9780132847377', 'algorithms')
ON CONFLICT DO NOTHING;

INSERT INTO course_books (course_id, book_id, relation)
VALUES
  ('CS301', '9780073523323', 'required'),
  ('CS301', '9780132847377', 'recommended'),
  ('CS201', '9780132847377', 'required')
ON CONFLICT DO NOTHING;
...
VALUES
  ('T1001', 'products', 'student', 'aarav@college.edu', 'Wrong book edition listed', 'The shown edition does not match the delivered copy.', '', '2026-04-01', 'new'),
...
VALUES
  ('T1001', 'new', 'student', 'aarav@college.edu'),
...
VALUES
  ('C1001', 'aarav@college.edu')
ON CONFLICT (student_id) DO NOTHING;

INSERT INTO cart_items (cart_id, book_id, quantity)
VALUES
  ('C1001', '9780073523323', 1)
ON CONFLICT DO NOTHING;
...
VALUES
  ('O9001', 'aarav@college.edu', '2-day', '**** **** **** 7621', '09/28', 'Aarav Sharma', 'Visa', 'awaiting shipping')
ON CONFLICT (id) DO NOTHING;

INSERT INTO order_items (order_id, book_id, quantity)
VALUES
  ('O9001', '9780073523323', 1)
ON CONFLICT DO NOTHING;
